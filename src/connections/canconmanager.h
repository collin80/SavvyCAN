...
public:
   ...
   * @param pFrame - reference to a CANFrame struct that has been filled out for
   * sending
   * @return bool specifying whether the send succeeded or not
   * @note Finds which CANConnection object is responsible for this bus and
   * automatically converts bus number to pass properly to CANConnection
   */
