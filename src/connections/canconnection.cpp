...
CANConnection::CANConnection(QString pPort, QString pDriver, CANCon::type pType, int pSerialSpeed, int pBusSpeed,
                             bool pCanFd, int pDataRate, int pNumBuses, int pQueueLen, bool pUseThread)
    : mNumBuses(pNumBuses)
...
void CANConnection::suspend(bool pSuspend)
{
  ...
  if (mThread_p && (mThread_p != QThread::currentThread()))
  {
    QMetaObject::invokeMethod(this, "suspend", Qt::BlockingQueuedConnection, Q_ARG(bool, pSuspend));
    return;
  }
...
bool CANConnection::getBusSettings(int pBusIdx, CANBus& pBus)
{
  ...
  {
    bool ret;
    QMetaObject::invokeMethod(this, "getBusSettings", Qt::BlockingQueuedConnection, Q_RETURN_ARG(bool, ret),
                              Q_ARG(int, pBusIdx), Q_ARG(CANBus&, pBus));
    return ret;
  }
...
void CANConnection::setBusSettings(int pBusIdx, CANBus pBus)
{
  ...
  if (mThread_p && (mThread_p != QThread::currentThread()))
  {
    QMetaObject::invokeMethod(this, "setBusSettings", Qt::BlockingQueuedConnection, Q_ARG(int, pBusIdx),
                              Q_ARG(CANBus, pBus));
    return;
  }
...
bool CANConnection::sendFrame(const CANFrame& pFrame)
{
  ...
  {
    bool ret;
    QMetaObject::invokeMethod(this, "sendFrame", Qt::BlockingQueuedConnection, Q_RETURN_ARG(bool, ret),
...
bool CANConnection::sendFrames(const QList<CANFrame>& pFrames)
{
  ...
  {
    bool ret;
    QMetaObject::invokeMethod(this, "sendFrames", Qt::BlockingQueuedConnection, Q_RETURN_ARG(bool, ret),
