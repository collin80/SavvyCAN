...
// Now inherits from the built-in CAN frame class from Qt. This should be more future proof and easier to integrate with
// other code
...
public:
  ...
  {
    if ((id == b.id) && (mask == b.mask) && (observer == b.observer))
      return true;
