...
{
    return new ISOTP_HANDLER(*MainWindow::getReference()->getCommFrameModel()->getListReference(),
            /* canSendCallback */ [](const CommFrame& pFrame){ CANConManager::getInstance()->sendFrame(pFrame); },
            ...
            return QObject::connect(
                    ...
                    handler,
                    [handler](void*, const QVector<CommFrame>& frames){
